    ...
    <body id="page-top" data-spy="scroll" data-target=".side-menu">
      ...
      <div class="container">
        ...
        <div class="row me-row content-ct">
          <h2 class="row-title">Why do we create this forum?</h2>
          <div class="col-md-4 feature">
            <span class="ti-ticket"></span>
            <h3>Bring convenience to students</h3>
            <p>Reason 1</p>
          </div>
          <div class="col-md-4 feature">
          ...
          <div class="col-md-4 feature">
            ...
            <h3>People around the Melbourne!</h3>
            <p>Reason 3</p>
          </div>
        </div>
        <!-- End: Desc -->
      ...
      <div class="container-fluid tickets" id="tickets">
        <div class="row me-row content-ct">
          <h2 class="row-title">How to join us?</h2>
          <div class="col-md-4 col-sm-6 col-md-offset-2">
            <h3>Early Bird Ticket</h3>
            <p class="price">Free</p>
            <p>All days entry pass for all the events.</p>
            <a href="#" class="btn btn-lg btn-red">Join Now<small></small></a>
          </div>
      ...
      <div class="container-fluid footer">
        <div class="row contact">
          ...
          <div class="col-md-4 col-md-offset-1 content-ct">
            <h3><span class="ti-twitter"></span>Sunrise Feed</h3>
            <p>Please <a href="#">subscribe</a>our Facebook channel and contact us via <a href="#">information@cssaunimelb.com</a> </p>
            <hr>
          </div>
        </div>
        <div class="row footer-credit">
          <div class="col-md-6 col-sm-6">
            <p>&copy; 2017, <a href="#">Sunrise.com</a> | All rights reserved.</p>
          </div>
          <div class="col-md-6 col-sm-6">
